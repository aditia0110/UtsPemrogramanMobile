## **Repositori ini dibuat untuk memenuhi penilaian Ujian Tengah Semester (UTS) matakuliah Pemrograman Mobile**  
...
berikut adalah link video aplikasi yang di jalankan (dijalankan pada device menggunakan usb debugging) : [tonton video](https://youtu.be/xENgn2FBhEs?si=6M0s3zG4_nbzQabH)  
<br>
Source Code:  
...
<RelativeLayout xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <LinearLayout
        ...
        <TextView
            ...
            android:text="Aditia Seftiawan (312210094)"
